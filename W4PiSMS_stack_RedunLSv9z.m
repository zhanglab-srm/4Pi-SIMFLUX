function [R_shift1 R_shift2 R_shift3 flag error1_final error2_final error3_final]=W4PiSMS_stack_RedunLSv9z(stksort,x1in,x2in,x3in,pixelsz,errothresh,cutmeth,iniguess,maskflag,cropsz)
