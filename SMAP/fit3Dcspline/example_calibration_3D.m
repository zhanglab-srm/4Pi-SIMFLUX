...
folder='I:\Yanqin Chen\20220330\3D beads in 640 channel for dSTORM\beads_3';
files=dir([folder filesep '*.tif']);
N=length(files);
for i=1:N
    p.filelist{i}=[folder filesep files(i).name];
end
p.outputfile = [folder filesep 'bead_astig_3dcal_20220330_640_channel_for dSTORM.mat' ]; %output file name
