...
% Last Modified by GUIDE v2.5 22-Apr-2020 14:56:31
...
addpath(path,'calibration_files\');
addpath(genpath('SMAP'))
addpath(genpath('ROSE'))

scmos_cali_file = 'sCMOS_calibration.mat';
handles.scmos_cali_file = scmos_cali_file;
handles.pixelsz = 128;  % pixel size: nm
handles.PAINT=1;        % PAINT

set(handles.center1,'string','415');
set(handles.center2,'string','848');
set(handles.center3,'string','1585');
set(handles.center4,'string','2019');
set(handles.fileNoThresh,'string','10');
...
if get(handles.selectGetpos,'value')
    filenum_threshold=str2double(get(handles.fileNoThresh,'string'));
    if pathname~=0
...
elseif get(handles.selectRecon,'value')
    if pathname~=0
        set(handles.pathMainfolder,'string',[pathname '\']);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
W4PiSMS_getTranform_v2(handles);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
W4PiSMS_reconstruction(handles);
...
% handles    structure with handles and user data (see GUIDATA)
%tuotuo
ind_selected = get(handles.pathSubfolder,'value');
dirlist = get(handles.pathSubfolder,'string');
dir_selected = dirlist(ind_selected);
%tuotuo

W4PiSMS_getPosition(handles);

if get(handles.checkbox7,'value')
    set(handles.selectRecon,'value',1)
    Selectionswitch_SelectionChangedFcn(hObject, eventdata, handles)
    %tuotuo
    checkbox67_helper(dir_selected, handles)
    %tuotuo
    W4PiSMS_GetIntensityEM(handles)
end
...
%tuotuo
function checkbox67_helper(dirs, handles)
for ii = 1:numel(dirs)
    currentdir = dirs{ii};
    [pathpart, namepart, ~] = fileparts(currentdir);
    resfile = dir([pathpart '\' namepart '_*tmpresult*.mat']);
    dirs{ii} = [resfile(1).folder '\' resfile(1).name];
end
set(handles.pathSubfolder,'string',dirs);
set(handles.pathSubfolder,'value',1:length(dirs));
%tuotuo
...
% --- Executes on button press in DriftCorrectionAlgo.
function DriftCorrectionAlgo_Callback(hObject, eventdata, handles)
% hObject    handle to DriftCorrectionAlgo (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of DriftCorrectionAlgo


function crlb_Callback(hObject, eventdata, handles)
% hObject    handle to crlb (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of crlb as text
%        str2double(get(hObject,'String')) returns contents of crlb as a double


% --- Executes during object creation, after setting all properties.
function crlb_CreateFcn(hObject, eventdata, handles)
% hObject    handle to crlb (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --------------------------------------------------------------------
function CamReg_Callback(hObject, eventdata, handles)
% hObject    handle to CamReg (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
W4PiSMS_two_camera_registration(handles)

% --------------------------------------------------------------------
function GetInten_Callback(hObject, eventdata, handles)
% hObject    handle to GetInten (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
if get(handles.selectGetpos,'value')
    set(handles.selectRecon,'value',1)
...
% --------------------------------------------------------------------
function ColorAssign_Callback(hObject, eventdata, handles)
% hObject    handle to ColorAssign (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
if get(handles.selectGetpos,'value')
    set(handles.selectRecon,'value',1)
...
W4PiSMS_color_assignment(handles)
...
% --------------------------------------------------------------------
function ExpertOn_Callback(hObject, eventdata, handles)
% hObject    handle to ExpertOn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.text21,'visible','on')
set(handles.fit_flag,'visible','on')
set(handles.MedFilter,'visible','on')
set(handles.MephiBinText,'visible','on')
set(handles.mephiBin,'visible','on')
set(handles.text19,'visible','on')
set(handles.numImages,'visible','on')
set(handles.beadsDriftCorr,'visible','on')
set(handles.phaseDriftCorr,'visible','on')
set(handles.ExpertOn,'check','on')
set(handles.ExpertOff,'check','off')

% --------------------------------------------------------------------
function ExpertOff_Callback(hObject, eventdata, handles)
% hObject    handle to ExpertOff (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.text21,'visible','off')
set(handles.fit_flag,'visible','off')
set(handles.MedFilter,'visible','off')
set(handles.MephiBinText,'visible','off')
set(handles.mephiBin,'visible','off')
set(handles.text19,'visible','off')
set(handles.numImages,'visible','off')
set(handles.beadsDriftCorr,'visible','off')
set(handles.phaseDriftCorr,'visible','off')
set(handles.ExpertOn,'check','off')
set(handles.ExpertOff,'check','on')
